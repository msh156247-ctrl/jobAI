      ...
      <div className="max-w-2xl w-full space-y-8">
        ...
        {currentStep === 1 && (
          <div className="bg-white p-8 shadow rounded-lg space-y-6">
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <button
                  ...
                  className={`py-8 border-2 rounded-lg font-medium transition-all duration-200 ${
                    role === 'seeker'
                      ? 'border-blue-600 bg-blue-50 text-blue-600 scale-105 shadow-md'
                      : 'border-gray-300 text-gray-700 hover:border-blue-400 hover:bg-blue-50 hover:scale-102'
                  }`}
                >
            ...
            <div>
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white text-gray-500">또는 간편 가입</span>
                </div>
              </div>
              ...
              <div className="mt-6 grid grid-cols-3 gap-3">
                <button
                  type="button"
                  onClick={() => alert('구글 간편 가입 준비 중입니다.')}
                ...
                <button
                  type="button"
                  onClick={() => alert('카카오 간편 가입 준비 중입니다.')}
                ...
                <button
                  type="button"
                  onClick={() => alert('네이버 간편 가입 준비 중입니다.')}
            ...
            <button
              onClick={nextStep}
              className="w-full bg-blue-600 text-white py-3 rounded-lg font-medium hover:bg-blue-700 transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]"
            >
              다음
            </button>
          </div>
